...
test('project Builder', function () {
    var expectResult = {
        field_name: 1,
        calculated_field: '$another_field',
        remove_field: 0,
    };
    var actualResult = new index_1.ProjectBuilder()
...
test('group Builder', function () {
    var expectResult = {
        _id: 'groupName',
        aggregated_field: { $sum: '$aggregated_val' },
    };
    var actualResult = new index_1.GroupBuilder('groupName').sum('aggregated_field', 'aggregated_val');
    expect(expectResult).toEqual(actualResult);
});
test('pipeline Builder', function () {
    var expectResult = [
        { $project: {} },
        { $addFields: {} },
        { $facet: {} },
    ...
    var actualResult = new index_1.Builder()
        .project({})
        .addFields({})
        .facet({})
        .unset({})
...
test('test structure', function () {
    ...
    var filterSources = new index_1.Expression(index_1.Operator.IN, ['mysql', 'can-api-default-ds']);
    var reviewStatusKey = new index_1.Comparison(index_1.Operator.EQ, '$$property.k', 'reviewStatus');
    var queryWithBuilder = new index_1.Builder()
